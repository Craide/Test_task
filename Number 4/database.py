...
try:
    ...
    create_table_query = '''CREATE TABLE IF NOT EXISTS transaction_details(
    ...
    for i in range(len(records)):
        insert_query = f'''INSERT INTO transaction_details (customer_id, item_id, item_number, transaction_dttm )
                            VALUES 
